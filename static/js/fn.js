...
function update(a){
  ...
  // ahu-04
  $('.ahu-04 .svg_sup').attr('stroke-dasharray', ((maxValue * Number(a.ahu03_sup_temp)/100) +", 1400"));
  $('.ahu-04 .svg_set').attr('stroke-dasharray', ((maxValue * Number(a.ahu03_set_temp)/100) +", 1400"));
  $('.ahu-04 .svg_sup_box .temp_value').html(Number(a.ahu03_sup_temp).toFixed(1) + " ℃");
  $('.ahu-04 .svg_set_box .temp_value').html(Number(a.ahu03_set_temp).toFixed(1) + " ℃");
